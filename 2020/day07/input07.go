...
var inputTest string = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
var inputTest2 string = `shiny gold bags contain 2 dark red bags.
...
var input string = `bright gray bags contain 2 bright gold bags, 5 dull lavender bags.
